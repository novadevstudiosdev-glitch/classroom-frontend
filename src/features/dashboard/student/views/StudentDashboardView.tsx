    ...
    <div className="relative min-h-screen">
      ...
      <main className="p-6  pt-20 md:pt-6 sm:p-6 md:p-8 overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          {/* MISION */}
          <motion.div className="md:col-span-2 bg-linear-to-br from-[#050816] to-[#3054FF] rounded-[20px] p-4 sm:p-6 text-white shadow-lg">
          ...
          {/* SUBJECT MAP */}
          <motion.div className="md:col-span-2 bg-white rounded-[20px] p-4 sm:p-6 shadow-lg">
            <h3 className="text-lg sm:text-xl font-black text-gray-800 mb-5">
              Mapa de Materias
            </h3>
          ...
          {/* ACTIVITY */}
          <motion.div className="bg-white rounded-[20px] p-4 sm:p-6 shadow-lg">
            ...
            <div className="flex flex-col gap-3">
              {[1, 2, 3].map((_, i) => (
                ...
                >
                  ...
                  <span className="text-xs sm:text-sm font-bold text-[#7C4DFF]">
                    95%
                  </span>
                </div>
              ))}
            ...
            <div className="flex flex-col gap-3">
              {[1, 2, 3].map((rank) => (
                ...
                >
                  ...
                  <span className="text-xs sm:text-sm text-[#7C4DFF]">
                    500 XP
                  </span>
                </div>
              ))}
          ...
          <motion.div
            ...
            className="bg-white rounded-[20px] p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all"
          >
            <div className="flex justify-between items-start mb-5">
          ...
          <motion.div
            ...
            className="bg-linear-to-br from-[#FB923C] to-[#F43F5E] rounded-[20px] p-4 sm:p-6 text-white shadow-lg hover:shadow-xl transition-all text-center cursor-pointer hover:-translate-y-1"
          >
